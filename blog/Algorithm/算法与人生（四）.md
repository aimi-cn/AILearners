...
&nbsp;<div align=center><img width = '500' height ='200' src =../../data/algorithm/suanfatujie2.png/></div>
...
&emsp;&emsp;分享一道《剑指offer》里的经典题目：“我们可以用2*1的小矩形横着或者竖着去覆盖更大的矩形。请问用n个2*1的小矩形无重叠地覆盖一个2*n的大矩形，总共有多少种方法？”留给大家思考。
