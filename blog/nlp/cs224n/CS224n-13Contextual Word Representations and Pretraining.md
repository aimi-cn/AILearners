...
目前为止，我们已经学过了one-hot编码、word2vec、glove等词向量的表示。但是这三个方法都普遍存在在一些问题，就是无法解决一次多义的问题，即对于同一个词无论上下文的单词是否相同，训练出来的词向量都是一样的。
...
但是，对于这样的解决方案存在着一定的问题，即：我们没有办法区分不同的unknown words。此外，到目前为止，对于每一个单词，我们都只拥有一个词向量，因此很难解决一词多义的问题。接下来，我们会介绍一些经典模型“
